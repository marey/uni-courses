// const API_URL = 'http://www.1217.com/',
const API_URL = 'https://murui.bitxspace.com/test',
      Q = require('../core/Q.js');

const FREELANCE_API = 'https://accounts.freelancer-sandbox.com';
...
function freeLancer(url, headers, method) {

      return Q.Promise(function (resolve, reject, notify) {
            wx.request({
                  url: FREELANCE_API + url,
                  header: headers,
                  method: method,
                  success: resolve,
                  fail: reject
...
module.exports = {
      ...
      // TODO test
      preProcessInitData(data, control) {
            return preProcessInitData(data, control);
      },
      //获得登录数据
